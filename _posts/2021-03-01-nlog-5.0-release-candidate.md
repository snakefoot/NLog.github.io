...
unless it has been explictly specified by the NLog.config. The extensions autoload feature was introduced with NLog 4.0,
...
which is used by default for NetCore.
